...
public class Source_Target {
    ...
    protected void responseSendError(HttpServletRequest request, HttpServletResponse response)
    	    throws ServletException, IOException {
    	        ...
    	        response.addHeader("X-Header", requestParameter + "was not found.");
    	        ...
    	        response.addHeader("X-Header", "Was not found: " + requestParameter );
    	        ...
    	        response.addHeader("X-Header", "Page " +requestParameter + " was not found!" );
